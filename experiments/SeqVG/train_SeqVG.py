...
def main():
    ...
    model_save_path = MODEL_PATH.joinpath('Decoder_SeqVG_latent{}_ch{}_coef1{}_coef1{}.npz'.format(
            args.latent, args.ch, args.coef1, args.coef2))
    model_save_path.parent.mkdir(parents=True, exist_ok=True)
    chainer.serializers.save_npz(str(model_save_path), dec)

    model_save_path = MODEL_PATH.joinpath('Encoder_SeqVG_latent{}_ch{}_coef1{}_coef1{}.npz'.format(
            args.latent, args.ch, args.coef1, args.coef2))
    model_save_path.parent.mkdir(parents=True, exist_ok=True)
    chainer.serializers.save_npz(str(model_save_path), enc)

    model_save_path = MODEL_PATH.joinpath('Discriminater_SeqVG_latent{}_ch{}_coef1{}_coef1{}.npz'.format(
            args.latent, args.ch, args.coef1, args.coef2))
    model_save_path.parent.mkdir(parents=True, exist_ok=True)
